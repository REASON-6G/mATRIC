...
3. **mAT Manager**<br>
The multiple Access Technology Manager consist of monitoring Applications (mApps) that manage different xApps for each Access Technology and Orchestrator services. <br>
